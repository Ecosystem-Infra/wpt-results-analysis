 ...
 *
 * The 'subtests' array may be missing, if the test is a single page test[0]. In
 * that case, the top level status will be a PASS/FAIL/TIMEOUT/etc rather than a
 * harness status.
 *
...
//
// Where test_results is a json dictionary as described in the module
// documentation.
